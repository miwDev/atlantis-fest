package com.msd.atlantis_fest.exception;

import com.msd.atlantis_fest.exception.custom.BusinessValidationException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BusinessValidationException.class, IllegalStateException.class})
